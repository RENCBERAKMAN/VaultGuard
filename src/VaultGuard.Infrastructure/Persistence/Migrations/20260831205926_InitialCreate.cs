        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastLoginAt = table.Column<DateTime>(type: "datetime2(7)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                comment: "DEĞİŞTİRİLEMEZ AUDIT LOG - SAKLAMA: 7 yıl (GDPR/SOC2). 2 yıl sonra cold storage'a arşivle. UPDATE VE DELETE İŞLEMLERİNE İZİN VERİLMEZ.");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EncryptedValue = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    IV = table.Column<byte[]>(type: "varbinary(12)", maxLength: 12, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_Action_IpAddress_Timestamp",
                table: "AuditLogs",
                columns: new[] { "Action", "IpAddress", "Timestamp" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Secrets_LastAccessedAt",
                table: "Secrets",
                column: "LastAccessedAt");

            migrationBuilder.CreateIndex(
                name: "IX_Secrets_Title",
                table: "Secrets",
                column: "Title");

            migrationBuilder.CreateIndex(
                name: "IX_Secrets_User_NotDeleted",
                table: "Secrets",
                columns: new[] { "UserId", "IsDeleted" },
                filter: "IsDeleted = 0");

            migrationBuilder.CreateIndex(
                name: "IX_Secrets_User_Title",
                table: "Secrets",
